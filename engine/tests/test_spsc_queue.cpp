// ============================================================================
// Test Suite: SPSCQueue
// Tests: push/pop, full queue, empty queue, wraparound, ordering guarantee
// ============================================================================
...
protected:
    static constexpr size_t CAPACITY = 16; // Power of 2

    EngineMemory memory{1024 * 1024}; // 1 MB
...
TEST_F(SPSCQueueTest, PopFreesSpaceForNewPush) {
    ...
    // Now one more push should succeed
...
TEST_F(SPSCQueueTest, ConcurrentProducerConsumer) {
    ...
    // Use a larger queue for the concurrent test
